...
3. `specs/tasks.md` - 実装やることリスト（段階的な実装手順）
...
```
requirements.md と design.md を元に、実装やることリストを作成します。
```
...
[design.mdのコンポーネントごとにやることを生成]

### 2.1 型定義の作成

**やること**: `types/index.ts` を作成
...
**やること**: `components/[Component1].tsx` を作成
